...
test1 = Test.find_or_create_by(title: 'Basic Math', level: 1, category_id: category1.id)

test2 = Test.find_or_create_by(title: 'Russian history.', level: 2, category_id: category2.id)

test3 = Test.find_or_create_by(title: 'Roman history.', level: 2, category_id: category2.id)
